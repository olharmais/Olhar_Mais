...
function adicionarBarraNavegacao() {
    ...
    const menuItems = [
        { 
            url: '/profissional/home_profi.html', 
            icon: 'house', 
            text: 'Início',
            active: currentPath.includes('home_profi')
        },
        { 
            url: '/profissional/frequencia_profi.html', 
            icon: 'check-circle', 
            text: 'Frequência',
            active: currentPath.includes('frequencia_profi')
        },
        { 
            url: '/profissional/perfil_profi.html', 
            icon: 'user', 
            text: 'Perfil',
            active: currentPath.includes('perfil_profi')
        },
        {
            url: '#',
            icon: 'sign-out',
