...
function adicionarBarraNavegacao() {
    ...
    const menuItems = [
        { 
            url: '/nutricionista/home_nutri.html', 
            icon: 'house', 
            text: 'Início',
            active: currentPath.includes('home_nutri')
        },
        { 
            url: '/nutricionista/frequencia_nutri.html', 
            icon: 'check-circle', 
            text: 'Frequência',
            active: currentPath.includes('frequencia_nutri')
        },
        { 
            url: '/nutricionista/perfil_nutri.html', 
            icon: 'user', 
            text: 'Perfil',
            active: currentPath.includes('perfil_nutri')
        },
        {
            url: '#',
            icon: 'sign-out',
